...
public abstract class CaseConfigurationDialog extends ConfigurationDialog {

    private JLabel price_label;
    private AdvancedTextField price_field;

    public CaseConfigurationDialog(String type, ConfigurationNode node) {
        super(SuperObjectType.CASE, type, node);
    ...
    public void save() {
        ...
        try {
            ...
            throw new RuntimeException("Exception saving Case Configuration Dialog!", e);
        }
    }
}
