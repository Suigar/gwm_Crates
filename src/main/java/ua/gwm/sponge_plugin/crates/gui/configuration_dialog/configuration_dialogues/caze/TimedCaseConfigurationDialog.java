...
public class TimedCaseConfigurationDialog extends CaseConfigurationDialog {
    ...
    public TimedCaseConfigurationDialog(ConfigurationNode node) {
        super("TIMED", node);
    ...
    public void save() {
        ...
        try {
            ...
            throw new RuntimeException("Exception saving Timed Case Configuration Dialog!", e);
        }
    }
}